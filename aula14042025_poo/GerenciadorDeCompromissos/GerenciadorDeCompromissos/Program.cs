...
Console.Write("Digite a data do compromisso (dd/MM/aaa): ");
...
while (true) {
    try 
    {
        TimeSpan timeSpan = TimeSpan.ParseExact(Console.ReadLine(), @"hh\:mm", System.Globalization.CultureInfo.InvariantCulture);
